...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-32 bg-gray-900 text-white relative overflow-hidden">
      {/* Background Ambience */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20" data-aos="fade-up">
          <span className="text-orange-500 font-bold tracking-wider uppercase text-sm mb-3 block">Success Stories</span>
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6 tracking-tight">
            {t('testimonials.title')}
          </h2>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Join thousands of healthcare professionals transforming their pharmacy operations.
          </p>
        </div>
